...
// export default function Product({ product }: ProductProps) {
//   const { addItem, cartDetails, redirectToCheckout } = useShoppingCart(); // Add redirectToCheckout
//   const { name, price, image } = product;
//   const [quantity, setQuantity] = useState(1);
...
//       .catch((error) => {
//         /* Error handling */
//         console.error("Response Error [Product.tsx]: " + error);
//       });
...
//       console.error("Response and SessionID Error [Product.tsx]");
//     }
//   };
...
//       <button
//         onClick={buyNow}
//         className="rounded-md bg-blue-500 px-5 py-2 text-white transition-colors duration-500 hover:bg-blue-600"
//       >
//         Buy Now
//       </button>
//     </article>
