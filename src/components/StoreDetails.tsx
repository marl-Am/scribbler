        ...
        <div className="item">
          <div className="flex items-center space-x-5">
            ...
            <div>
              ...
              <p className="text-gray text-sm">When ordering over $8.99</p>
            </div>
          </div>
        </div>
        <div className="item">
          <div className="flex items-center space-x-5">
            ...
            <div>
              ...
              <p className="text-gray text-sm">Items As Is</p>
            </div>
          </div>
        </div>
        <div className="item">
          <div className="flex items-center space-x-5">
            ...
            <div>
              ...
              <p className="text-qgray text-sm">100% Secure Online Payment</p>
            </div>
          </div>
        </div>
        <div className="item">
          <div className="flex items-center space-x-5">
            ...
            <div>
              ...
              <p className="text-gray text-sm">Original Product Guarenteed</p>
            </div>
          </div>
        </div>
      </div>
